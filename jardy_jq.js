...
if ((t ? t.ownerDocument || t :U) !== O && B(t), t = t || O, n = n || [], !e || "string" != typeof e) return n;
...
function S() {}
var E, T, N, A, $, M, D, I, P, B, O, R, L, H, F, j, z, W = "sizzle" + -new Date(), U = e.document, V = 0, q = 0, K = r(), G = r(), Y = r(), Q = !1, J = function() {
return 0;
...
}, T = n.support = {}, B = n.setDocument = function(e) {
...
return i ? 1 & i || !T.sortDetached && n.compareDocumentPosition(e) === i ? e === t || z(U, e) ? -1 :n === t || z(U, n) ? 1 :P ? at.call(P, e) - at.call(P, n) :0 :4 & i ? -1 :1 :e.compareDocumentPosition ? -1 :1;
} :function(e, n) {
var i, r = 0, o = e.parentNode, a = n.parentNode, s = [ e ], l = [ n ];
if (e === n) return Q = !0, 0;
if (!o || !a) return e === t ? -1 :n === t ? 1 :o ? -1 :a ? 1 :P ? at.call(P, e) - at.call(P, n) :0;
if (o === a) return d(e, n);
...
if ((e.ownerDocument || e) !== O && B(e), t = t.replace(yt, "='$1']"), !(!T.matchesSelector || !L || F && F.test(t) || H && H.test(t))) try {
var i = j.call(e, t);
if (i || T.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i;
} catch (r) {}
return n(t, O, null, [ e ]).length > 0;
}, n.contains = function(e, t) {
return (e.ownerDocument || e) !== O && B(e), z(e, t);
}, n.attr = function(e, n) {
...
var t, n = [], i = 0, r = 0;
if (Q = !T.detectDuplicates, P = !T.sortStable && e.slice(0), e.sort(J), Q) {
...
T.sortStable = W.split("").sort(J).join("") === W, B(), [ 0, 0 ].sort(J), T.detectDuplicates = Q, 
...
var Nt, At, $t = /[\t\r\n\f]/g, Mt = /\r/g, Dt = /^(?:input|select|textarea|button|object)$/i, It = /^(?:a|area)$/i, Pt = /^(?:checked|selected)$/i, Bt = ut.support.getSetAttribute, Ot = ut.support.input;
ut.fn.extend({
attr:function(e, t) {
...
if (o && 1 === e.nodeType) for (;n = o[r++]; ) i = ut.propFix[n] || n, ut.expr.match.bool.test(n) ? Ot && Bt || !Pt.test(n) ? e[i] = !1 :e[ut.camelCase("default-" + n)] = e[i] = !1 :ut.attr(e, n, ""), 
...
set:function(e, t, n) {
return t === !1 ? ut.removeAttr(e, n) :Ot && Bt || !Pt.test(n) ? e.setAttribute(!Bt && ut.propFix[n] || n, n) :e[ut.camelCase("default-" + n)] = e[n] = !0, 
n;
}
}, ut.each(ut.expr.match.bool.source.match(/\w+/g), function(e, n) {
var i = ut.expr.attrHandle[n] || ut.find.attr;
ut.expr.attrHandle[n] = Ot && Bt || !Pt.test(n) ? function(e, n, r) {
...
o = e >= 200 && 300 > e || 304 === e, i && (b = P(h, x, i)), b = B(h, b, x, o), 
...
if (m.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, h.url = ((e || h.url || Dn) + "").replace(Bn, "").replace(Fn, Mn[1] + "//"), 
...
h.hasContent = !Hn.test(h.type), a = h.url, h.hasContent || (h.data && (a = h.url += (Pn.test(a) ? "&" :"?") + h.data, 
delete h.data), h.cache === !1 && (h.url = On.test(a) ? a.replace(On, "$1_=" + In++) :a + (Pn.test(a) ? "&" :"?") + "_=" + In++)), 
...
l ? n[l] = n[l].replace(Gn, "$1" + o) :n.jsonp !== !1 && (n.url += (Pn.test(n.url) ? "&" :"?") + n.jsonp + "=" + o), 
